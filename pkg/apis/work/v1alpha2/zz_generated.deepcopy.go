...
func (in *Component) DeepCopyInto(out *Component) {
	*out = *in
	if in.ReplicaRequirements != nil {
		...
		*out = new(ComponentReplicaRequirements)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
func (in *ObjectReference) DeepCopyInto(out *ObjectReference) {
	*out = *in
	if in.AffinityGroupLabel != nil {
		in, out := &in.AffinityGroupLabel, &out.AffinityGroupLabel
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *ResourceBindingSpec) DeepCopyInto(out *ResourceBindingSpec) {
	*out = *in
	...
	if in.WorkloadAffinityGroups != nil {
		in, out := &in.WorkloadAffinityGroups, &out.WorkloadAffinityGroups
		*out = new(WorkloadAffinityGroups)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadAffinityGroups) DeepCopyInto(out *WorkloadAffinityGroups) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadAffinityGroups.
func (in *WorkloadAffinityGroups) DeepCopy() *WorkloadAffinityGroups {
	if in == nil {
		return nil
	}
	out := new(WorkloadAffinityGroups)
